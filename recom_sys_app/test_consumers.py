...
class TestChatConsumer:
    ...
    async def test_general_exception_handling(self):
        ...
        assert 'error' in response['type'].lower() or 'empty' in response.get('message', '').lower()
