...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = [
            'id', 'user', 'name', 'sex', 'age', 'date_of_birth',
            'computed_age', 'country', 'favourite_genre1', 'favourite_genre2',
...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    favourite_genre1 = serializers.ChoiceField(choices=Genre.choices, required=False, allow_blank=True)
    favourite_genre2 = serializers.ChoiceField(choices=Genre.choices, required=False, allow_blank=True)
